  ...
  return (
    <footer style={{ background: '#000000', padding: '4.5vw 5.2% 0', overflow: 'hidden' }}>
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 24, flexWrap: 'wrap' }}>
        <div>
          <div data-reveal="rise" style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div
            data-reveal="rise"
            style={{ color: '#5f5f5f', fontSize: 13, marginTop: 12, '--delay': '90ms' } as CSSProperties}
          >
            Screen Off. Voice On.
          </div>
        </div>
      ...
      <div aria-hidden="true" style={{ position: 'relative', margin: '7vw -4% -5vw' }}>
        ...
        <img
          src="/launch/wordmark-outline.png"
          alt=""
